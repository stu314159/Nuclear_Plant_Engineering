...
\begin{enumerate}
\item Download Anaconda (Anaconda3, Windows 64-bit, Python version 3.8) \marginnote[-2.25cm]{\textbf{Note: }If you opt for this method, you will have Python installed on your own laptop.  This is worthwhile.  When you graduate from USNA you will lose access to MATLAB along with all of the other non-free software packages that you may have become accustomed to using as a midshipman.  Python is free and you can take it with you and it can become the most powerful tool in your computational toolbox.}
