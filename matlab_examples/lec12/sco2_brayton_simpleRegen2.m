...
% state point 6
P(6) = P(5);
h(6) = h(5) - xi_regen*(h(5) - gas.h_pT(P(6),T(2)));
...
Ex_d_regen = ef(5) + ef(2) - ef(6) - ef(3);


w_net = w_comp + w_turb;
q_net = q_s + q_r;

Flow_ex_balance = (ef_in - ef_out) - (w_net + Ex_d_regen);
...
fprintf('Exergy destroyed in the regen: %g kJ/kg \n',...
    Ex_d_regen);
